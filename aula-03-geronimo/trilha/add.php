...
if (count($_POST) > 0) {
    if (count($_GET) > 0) {
        ...
        try {
            ...
            if ($success) {
                $sql = "SELECT * FROM trilha WHERE id={$_GET['id']}";
                $std = $db->prepare($sql);
                ...
                echo "<p>Trilha atualizada!</p>";
            } else {
                echo "<p>Erro ao atualizar a trilha!</p>";
            }
                ...
                <form method="post">
                    ...
                    if (count($_GET) > 0) {
                        ...
                        if ($success) {
                            ...
                            $description = $result[0]->descricao;
